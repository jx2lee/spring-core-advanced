...
public class ParameterTest {
    ...
    static class ParameterAspect {
        ...
        @Pointcut("execution(* io.github.jx2lee.aop.member..*.*(..))")
        ...
        public void thisArgs(JoinPoint joinPoint, MemberService obj) {
            // 실제 참조하는 객체 반환
            // obj=class io.github.jx2lee.aop.member.MemberServiceImpl
        ...
        public void targetArgs(JoinPoint joinPoint, MemberService obj) {
            // 프록시 객체 반환
            // obj=class io.github.jx2lee.aop.member.MemberServiceImpl$$EnhancerBySpringCGLIB$$50dc591e
